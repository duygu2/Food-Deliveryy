...
import com.demo.foodorderanddeliveryappkotlin.SuccessOrderActivity
import com.duyguorhan.yemeksiparisi.adapter.PlaceYourOrderAdapter
...
class PlaceYourOrderActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        switchDelivery?.setOnCheckedChangeListener{
